...
public class SynchronizedAttribute {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// When threads are executing in parallel and the object is not thread-safe, like ArrayList, they block the list while inserting a value
		...
		jsez22.Threads.Number n1 = new jsez22.Threads.Number(0, 10000, numbers);
		Thread t1 = new Thread(n1);
		
		jsez22.Threads.Number n2 = new jsez22.Threads.Number(10000, 20000, numbers);
