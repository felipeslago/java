...
public class Quantifiers {
	...
	public static void main(String[] args) {
		...
		regex = text.matches("\\w{2,}"); // The quantifier {2,} specifies that the String must have at least 2 any MetaCharacters
		System.out.println(regex);
		
		regex = text.matches("\\w{2,5}"); // The quantifier {2,5} specifies that the String must have at least 2 any MetaCharacters and maximum of 5 MetaCharacters
		System.out.println(regex);
