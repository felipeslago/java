...
public class UsingDefaultMethods implements DefaultMethods {
    ...
    public static void main (String[] args) {
        ...
        int sum = DefaultMethods.sum(5, 5); // Usando método estático diretamente da interface
        usingDefaultMethods.print(sum);
        usingDefaultMethods.sumAndPrint(5, 5); // Usando método default a partir da instância
    }
