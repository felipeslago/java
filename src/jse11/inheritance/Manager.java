...
public class Manager extends Employee { // O comando extends determina que a classe Manager irá herder da classe Employee
	...
	/**
	 * Quando herdamos uma classe, herdamos também seus métodos e atributos
