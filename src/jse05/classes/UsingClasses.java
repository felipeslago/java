...
public class UsingClasses {
	...
	public static void main(String[] args) {
		...
		/**
		 * Objetos são definidos como se fossem variáveis, porém são criado através do comando new
         */
		...
		account.deposit(100.0); // Chamando um método do objeto, passando um parâmetro
	
		System.out.println("Owner: " + account.owner);
		System.out.println("Total balance: " + account.totalBalance()); // Acessando um método do objeto que retorna um valor
