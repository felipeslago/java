...
public class Metacharacters {
	...
	/*
		...
		"\w" any letter or number							[a-zA-Z_0-9]
		"\W" any character that is not a letter or a number	[^\w]
		"\s" any spaces or tabs								[\t\n\x0B\f\r]
		"\S" any character that doesn't have spaces or tabs	[^\s]
	*/ 
	...
	public static void main(String[] args) {
		...
		regex = phone.matches("\\d{3} \\d{3}-\\d{4}"); // It is important to use two \\ that represents a escape character
