...
public class ToStringAndEqualsMethods {
    ...
    // The contract defined the Object class specifies that the Equals method must return false if the passed object is
    // not the same as the class

    public boolean equals(Object object) {

        if (!(object instanceof ToStringAndEqualsMethods)) { // The instance of operator indicates if the passed object
