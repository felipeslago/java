...
public class UsingTemplateMethod {
    ...
    // In this example the intention is to calculate many different commissions based on total of items sold and its
    // total amount
    // The Salesman and the Manager has different commissions and different goals of total items sold and total amount

    // The solution is create a default method to calculate the commission and pass the buck to the child classes for
    // setting the calculations of total items and total amount
