...
public class UnmodifiableListMethod {
    ...
    public static void main(String[] args) {
        ...
        // The getFriends method returns a list of Number objects
        // From this list is possible to add new Number objects that will reflect in the Person object because it has
        ...
        // But just the Person class must have access to modify the Number list
        // It is possible to program in a defensive way to avoid this kind of code
        // By using the Collections.unmodifiableList method, when returning the list, it is possible to return a copy of
        // this object that is read-only
