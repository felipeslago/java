...
public class ArrayListXLinkedList {
    ...
    public static void main(String[] args) {
        ...
        // Meanwhile LinkedList uses a double linked list, that has nodes and each node has two fields specifying the
        // previous and the next element

        // ArrayList works better for getting an specified object, but inserting a new object in the top of the list
        // will be slow
