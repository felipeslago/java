...
public class UsingStrategy {
    ...
    // Design Patterns are standard techniques that simplify the code by writing it in a simple way with Object
    // Orientation
    ...
    // In this solution, every class that is a Tax must implement the Tax Interface, ensuring that its have the method
    // to calculate the Tax
    // The TaxCalculator class receives a Budget and a generic Tax and like every Tax has the calculate method its know
    // what to do
