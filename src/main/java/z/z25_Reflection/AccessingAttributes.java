...
public class AccessingAttributes {
    ...
    public static void listObjectAttributes(Object obj) throws Exception {
        ...
        for (Field field : fields) {
            System.out.println(field.getType() + " - " + field.getName() + " - " + field.get(obj)); // Gets the
                                                                                                    // attribute type,
                                                                                                    // name and value
        }

        fields = c.getDeclaredFields(); // Gets PUBLIC and PRIVATE attributes, but not gets the attributes from the
                                        // superclass
