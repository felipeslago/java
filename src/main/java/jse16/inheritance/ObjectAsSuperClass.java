...
public class ObjectAsSuperClass implements Cloneable {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        ObjectAsSuperClass objectAsSuperClassClone = (ObjectAsSuperClass) objectAsSuperClass
                .clone(); // Note que esse metodo retorna um objeto, portanto e necessario fazer o cast
    ...
    class Overriding {
        ...
        public boolean equals(
                final Object obj) { // Como por exemplo, reescrever o metodo para comparar cada campo de um objeto, ao
        ...
        protected void finalize()
                throws Throwable { // O metodo finalize e chamada assim que o objeto e destruido pelo garbage colector
            super.finalize();
