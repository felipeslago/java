package jse01_variables;

public class PrimitiveDataType {

    /**
     * Ao declarar variaveis, primeiramente devemos definir seu tipo e depois seu nome Adicionalmente, pode-se definir o
     * seu valor na declaracaoo, o que e chamado de inicializacao
     */

    public static void main(String[] args) {

        /**
         * Ao declarar uma variavel e nao inicializa-la, ela assume um valor default:
         *
         * Tipo: Valor Default: ------- --------------- byte 0 short 0 int 0 long 0L float 0.0f double 0.0d boolean
         * false char \u0000
         */

        /**
         * O operador = e utilizado para atribuir valores as variaveis
         */
