...
public class ObjectStreams {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Calendar[] invoices = { new GregorianCalendar(2000, 0, 1), new GregorianCalendar(2000, 1, 1),
                new GregorianCalendar(2000, 2, 1), new GregorianCalendar(2000, 3, 1), new GregorianCalendar(2000, 4, 1) };
