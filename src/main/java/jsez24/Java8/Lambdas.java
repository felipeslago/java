...
public class Lambdas {
	...
	public static void main(String[] args) {
		...
		// Instead of creating Comparator and Consumers to use the Default Methods of List class, it is possible to use the lambda syntax
		...
		// Functional Interfaces are interfaces that has just one abstract method, so the compiler knows what method is being implemented while using lamda syntax
