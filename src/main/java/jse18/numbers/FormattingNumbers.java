...
public class FormattingNumbers {
    ...
    public static void main(String[] args) {
        ...
        System.out.format("%nValor inteiro formatado: %08d",
                num1); // %08d especifica que o numero tera 8 posicoes com zeros a esquerda

        System.out.format("%nValor double formatado: %.2f%n",
                num2.doubleValue()); // %.2f especifica que o numero tera 2 casas decimais apos a virgula (ou ponto)
